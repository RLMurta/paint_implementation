...
class Button:
    def __init__(self, x, y, width, height, color, text=None, text_color=BLACK, background_color=WHITE):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
    ...
    def draw(self, win):
        pygame.draw.rect(
            win, self.background_color, (self.x, self.y, self.width, self.height))
        pygame.draw.rect(
